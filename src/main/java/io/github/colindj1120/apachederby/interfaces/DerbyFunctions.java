...
import io.github.colindj1120.sqlbase.interfaces.SqlFunctions;

public interface DerbyFunctions extends SqlFunctions {
    DerbyFunctions concat           = args -> String.format(ArgsUtility.buildArgsString(args));
    DerbyFunctions identityValLocal = args -> "IDENTITY_VAL_LOCAL()";
}
