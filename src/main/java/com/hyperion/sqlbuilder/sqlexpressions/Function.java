...
public class Function extends SqlExpression<Function> {
    ...
    public static Function function(SqlFunctionProvider functionProvider, SqlExpression<?>... args) {
        return new Function(functionProvider, null, args);
    }

    public static Function function(SqlFunctionProvider functionProvider, String alias, SqlExpression<?>... args) {
